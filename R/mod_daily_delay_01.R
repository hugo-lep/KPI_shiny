...
#################################################################################
############################ UI -> pour tableau de vols annulés #################
#################################################################################

mod_daily_delay_0_ui <- function(id){
  ns <- NS(id)
  tagList(
    rHandsontableOutput(ns("vols_annules"))
  )
}
####################################################################################################
##################### Section Serveur ##############################################################
...
mod_daily_delay_01_server <- function(id) {
  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      #########################################################################################################
      ################################################## calcul du tableau principale de retard ###############
      #########################################################################################################
...
#      output$test2 <- renderPrint(str(test28()))
      ...
      #########################################################################################################
      ############################################ calcul nombre de vols effectués dans la journée ###########
      #########################################################################################################
      ...
      #########################################################################################################
      ############################################ calcul nombre de vols en retard pour la journée #############
      #########################################################################################################
      ...
      #########################################################################################################
      ################################################## calcul pontualité de la journée ######################
      #########################################################################################################
      ...
      ##############################################   tableau vol annulés ####################################
      #########################################################################################################
      output$vols_annules <- renderRHandsontable(
        test26() %>%
          filter(flightLegStatus.cancelled == TRUE) %>%
